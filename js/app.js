...
function eventListeners() {
  ...
  //show info
  // document
  //   .querySelector(".work-modal__info")
  //   .addEventListener("click", function() {
  //     ui.showInfo();
  //   });

  document
    .querySelector(".sign-up__links")
    .addEventListener("click", function() {
...
UI.prototype.showLogin = function() {
  ...
  if (
    document.querySelector(".loginPage").classList.contains("work-modal-login")
  ) {
    modal.classList.add("work-modal--show");
  }
};
...
UI.prototype.closeLogin = function() {
  ...
  document
    .querySelector(".work-modal-login")
    .classList.remove("work-modal--show");
};
...
//   infox[1] =
//     "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Asperiores omnis praesentium at maiores amet illo suscipit animi porro tempora totam.";
